...
export const getPemohon = async (req, res) => {
  try {
...
export const getPemohonById = async (req, res) => {
  try {
...
export const createPemohon = async (req, res) => {
...
export const updatePemohon = async (req, res) => {
  try {
...
export const deletePemohon = async (req, res) => {
  try {
    const pemohon = await Pemohon.findOne({
      where: {
        uuid: req.params.id,
